 ...
 * @author Jamie
 */
public class StateBoardGame extends StateBoardAbstract
{
    // Pause
    ...
    private Rectangle interactArea = new Rectangle(1050, 538, 266, 200);

    public StateBoardGame(String ref, String board)
    {
        // Board
        super(ref);
        //this.board = new BoardData("REF");
        this.board = BoardLoader.load("C:/Users/Jamie/Documents/NetBeansProjects/JTK/Games/Venture/src/resources/board/temp1.jtk");
        this.board.setState(this);
        ...
        // Harvest
        this.board.addHarvest("MUSHROOM1", 16, 8);
    ...
    public void render(Graphics g)
    {
        ...
        // Interact Hint
        if(this.interactActive) {this.renderInteract(g);}
    ...
    private void renderInteract(Graphics g)
    {
        // Shadow
        GFX.drawRect(g, RectangleTool.offset(this.interactArea, 4, 4), "BLACK", true);
        
        // Background
        GFX.drawRect(g, this.interactArea, "WHITE", true);
        
        // Border
        GFX.drawRect(g, this.interactArea, "BLACK", false);
        
        // Hint
        GFX.write(g, this.interactHint, this.interactArea.x + 50, this.interactArea.y + 40, "LEFT", "MENU_OPTION", "BLACK");
    }
